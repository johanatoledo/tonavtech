 ...
 navbar: {
  ...
  desc: {
    ...
    system: {
      ...
      content: "Más allá del código, me especializo en la columna vertebral de tu proyecto. Gestionando servidores, orquestación componetizada y seguridad con Cloud."
    },
    db: {
